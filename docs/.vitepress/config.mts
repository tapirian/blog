        ...
        items: [
          {
            ...
            items: [
              ...
              { text: "Beego框架速通", link: "/golang/apply/beego" },
              { text: "Chi框架速通", link: "/golang/apply/chi" },
              { text: "grpc-go框架速通", link: "/golang/apply/grpc-go" },
              { text: "go-zero框架速通", link: "/golang/apply/go-zero" },
              { text: "go-micro框架速通", link: "/golang/apply/go-micro" },
